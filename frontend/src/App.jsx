    ...
    <div className="app">
      ...
      <nav className="nav-tabs">
        <div className="nav-tabs-inner">
          ...
          <button className={`nav-tab ${tab === TABS.PREFS ? 'active' : ''}`} onClick={() => { setTab(TABS.PREFS); setSelectedReceipt(null); setShowPayment(null); }}>
            <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor">
            ...
            <span className="nav-tab-label">Prefs</span>
          </button>
        </div>
      </nav>
    </div>
